...
const MapTabContent = memo(function MapTabContent() {
  return (
    <div className="relative pt-24 pb-[calc(50px+env(safe-area-inset-bottom))] h-[calc(100vh-50px-env(safe-area-inset-bottom))]">
      <MapView />
    </div>
  );
});
...
const ListTabContent = memo(function ListTabContent({ 
  ...
  return (
    <div className="flex flex-col pt-24 pb-[calc(50px+env(safe-area-inset-bottom))] h-[calc(100vh-50px-env(safe-area-inset-bottom))]">
...
const SettingsTabContent = memo(function SettingsTabContent() {
  return (
    <div className="flex flex-col pt-14 pb-[calc(50px+env(safe-area-inset-bottom))] h-[calc(100vh-50px-env(safe-area-inset-bottom))]">
