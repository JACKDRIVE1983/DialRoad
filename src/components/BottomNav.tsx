...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  ...
  return (
    <>
      ...
      >
        <div 
          className="mx-auto max-w-sm rounded-[24px] overflow-hidden bg-white/95 dark:bg-card/95 backdrop-blur-2xl border border-white/60 dark:border-white/10"
          style={{
      ...
      <AnimatePresence>
        {showFilters && (
          <>
            ...
            {/* Filter panel */}
            <motion.div
              className="fixed bottom-32 right-4 left-4 z-50 bg-background dark:bg-card backdrop-blur-2xl rounded-2xl p-4 max-h-[50vh] overflow-y-auto border border-border"
              style={{
